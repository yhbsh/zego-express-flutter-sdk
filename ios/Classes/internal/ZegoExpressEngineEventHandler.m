...
#define GUARD_SINK                                                                                                                                                                 \
    if (!sink) {                                                                                                                                                                   \
        ZGError(@"[%s] FlutterEventSink is nil", __FUNCTION__);                                                                                                                    \
    }
...
- (void)onDebugError:(int)errorCode funcName:(NSString *)funcName info:(NSString *)info {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onDebugError", @"errorCode" : @(errorCode), @"funcName" : funcName, @"info" : info});
    }
}
...
- (void)onApiCalledResult:(int)errorCode funcName:(NSString *)funcName info:(NSString *)info {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onApiCalledResult", @"errorCode" : @(errorCode), @"funcName" : funcName, @"info" : info});
    }
}
...
- (void)onFatalError:(int)errorCode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onFatalError", @"errorCode" : @(errorCode)});
    }
}
...
- (void)onEngineStateUpdate:(ZegoEngineState)state {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onEngineStateUpdate", @"state" : @(state)});
    }
}
...
- (void)onNetworkTimeSynchronized {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onNetworkTimeSynchronized"});
    }
}
...
- (void)onStartDumpData:(int)errorCode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onStartDumpData", @"errorCode" : @(errorCode)});
    }
}
...
- (void)onStopDumpData:(int)errorCode dumpDir:(NSString *)dumpDir {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onStopDumpData", @"errorCode" : @(errorCode), @"dumpDir" : dumpDir});
    }
}
...
- (void)onUploadDumpData:(int)errorCode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onUploadDumpData", @"errorCode" : @(errorCode)});
    }
}
...
- (void)onRoomStateUpdate:(ZegoRoomState)state errorCode:(int)errorCode extendedData:(NSDictionary *)extendedData roomID:(NSString *)roomID {
    ...
    if (sink) {
        ...
        sink(@{@"method" : @"onRoomStateUpdate", @"state" : @(state), @"errorCode" : @(errorCode), @"extendedData" : extendedDataJsonString, @"roomID" : roomID});
    }
}
...
- (void)onRoomStateChanged:(ZegoRoomStateChangedReason)reason errorCode:(int)errorCode extendedData:(NSDictionary *)extendedData roomID:(NSString *)roomID {
    ...
    if (sink) {
        ...
        sink(@{@"method" : @"onRoomStateChanged", @"reason" : @(reason), @"errorCode" : @(errorCode), @"extendedData" : extendedDataJsonString, @"roomID" : roomID});
    }
}
...
- (void)onRoomUserUpdate:(ZegoUpdateType)updateType userList:(NSArray<ZegoUser *> *)userList roomID:(NSString *)roomID {
    ...
    if (sink) {
        ...
        for (ZegoUser *user in userList) {
            [userListArray addObject:@{@"userID" : user.userID == nil ? @"" : user.userID, @"userName" : user.userName == nil ? @"" : user.userName}];
        }

        sink(@{@"method" : @"onRoomUserUpdate", @"updateType" : @(updateType), @"userList" : userListArray, @"roomID" : roomID});
    }
}
...
- (void)onRoomOnlineUserCountUpdate:(int)count roomID:(NSString *)roomID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRoomOnlineUserCountUpdate", @"count" : @(count), @"roomID" : roomID});
    }
}

- (void)onRoomStreamUpdate:(ZegoUpdateType)updateType streamList:(NSArray<ZegoStream *> *)streamList extendedData:(NSDictionary *)extendedData roomID:(NSString *)roomID {
    FlutterEventSink sink = _eventSink;
    ZGLog(@"[onRoomStreamUpdate] updateType: %@, streamsCount: %d, extendedDataLength: %d, roomID: %@",
          updateType == ZegoUpdateTypeAdd ? @"Add" : @"Delete",
          (int) streamList.count,
          (int) extendedData.count,
          roomID);
    ...
    if (sink) {
        ...
        for (ZegoStream *stream in streamList) {
            ...
            [streamListArray addObject:@{@"user" : @{@"userID" : userID, @"userName" : userName}, @"streamID" : stream.streamID, @"extraInfo" : stream.extraInfo}];
        }
        ...
        sink(@{@"method" : @"onRoomStreamUpdate", @"updateType" : @(updateType), @"streamList" : streamListArray, @"roomID" : roomID, @"extendedData" : extendedDataJsonString});
    }
}
...
- (void)onRoomStreamExtraInfoUpdate:(NSArray<ZegoStream *> *)streamList roomID:(NSString *)roomID {
    ...
    if (sink) {
        ...
        for (ZegoStream *stream in streamList) {
            [streamListArray
                addObject:@{@"user" : @{@"userID" : stream.user.userID, @"userName" : stream.user.userName}, @"streamID" : stream.streamID, @"extraInfo" : stream.extraInfo}];
        }

        sink(@{@"method" : @"onRoomStreamExtraInfoUpdate", @"streamList" : streamListArray, @"roomID" : roomID});
    }
}
    ...
    if (sink) {
        ...
        for (ZegoRoomExtraInfo *info in roomExtraInfoList) {
            [roomExtraInfoListArray addObject:@{
                @"key" : info.key,
                @"value" : info.value,
                @"updateUser" : @{@"userID" : info.updateUser.userID, @"userName" : info.updateUser.userName},
                @"updateTime" : @(info.updateTime)
            }];
        }

        sink(@{@"method" : @"onRoomExtraInfoUpdate", @"roomExtraInfoList" : roomExtraInfoListArray, @"roomID" : roomID});
    }
}
...
- (void)onRoomTokenWillExpire:(int)remainTimeInSecond roomID:(NSString *)roomID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRoomTokenWillExpire", @"remainTimeInSecond" : @(remainTimeInSecond), @"roomID" : roomID});
    }
}
...
- (void)onPublisherStateUpdate:(ZegoPublisherState)state errorCode:(int)errorCode extendedData:(NSDictionary *)extendedData streamID:(NSString *)streamID {
    ...
    if (sink) {
        ...
        sink(@{@"method" : @"onPublisherStateUpdate", @"state" : @(state), @"errorCode" : @(errorCode), @"extendedData" : extendedDataJsonString, @"streamID" : streamID});
    }
}
...
- (void)onPublisherCapturedVideoFirstFrame:(ZegoPublishChannel)channel {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherCapturedVideoFirstFrame", @"channel" : @(channel)});
    }
}
...
- (void)onPublisherSendAudioFirstFrame:(ZegoPublishChannel)channel {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherSendAudioFirstFrame", @"channel" : @(channel)});
    }
}
...
- (void)onPublisherSendVideoFirstFrame:(ZegoPublishChannel)channel {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherSendVideoFirstFrame", @"channel" : @(channel)});
    }
}
...
- (void)onPublisherRenderVideoFirstFrame:(ZegoPublishChannel)channel {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherRenderVideoFirstFrame", @"channel" : @(channel)});
    }
}
...
- (void)onPublisherVideoSizeChanged:(CGSize)size channel:(ZegoPublishChannel)channel {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherVideoSizeChanged", @"width" : @((int) size.width), @"height" : @((int) size.height), @"channel" : @(channel)});
    }
}
...
- (void)onPublisherRelayCDNStateUpdate:(NSArray<ZegoStreamRelayCDNInfo *> *)streamInfoList streamID:(NSString *)streamID {
    ...
    if (sink) {
        ...
        for (ZegoStreamRelayCDNInfo *info in streamInfoList) {
            [streamInfoListArray addObject:@{@"url" : info.url, @"state" : @(info.state), @"updateReason" : @(info.updateReason), @"stateTime" : @(info.stateTime)}];
        }

        sink(@{@"method" : @"onPublisherRelayCDNStateUpdate", @"streamInfoList" : streamInfoListArray, @"streamID" : streamID});
    }
}
...
- (void)onPublisherVideoEncoderChanged:(ZegoVideoCodecID)fromCodecID toCodecID:(ZegoVideoCodecID)toCodecID channel:(ZegoPublishChannel)channel {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherVideoEncoderChanged", @"fromCodecID" : @(fromCodecID), @"toCodecID" : @(toCodecID), @"channel" : @(channel)});
    }
}
...
- (void)onPublisherStreamEvent:(ZegoStreamEvent)eventID streamID:(NSString *)streamID extraInfo:(NSString *)extraInfo {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPublisherStreamEvent", @"eventID" : @(eventID), @"streamID" : streamID, @"extraInfo" : extraInfo});
    }
}
...
- (void)onVideoObjectSegmentationStateChanged:(ZegoObjectSegmentationState)state channel:(ZegoPublishChannel)channel errorCode:(int)errorCode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onVideoObjectSegmentationStateChanged", @"state" : @((int) state), @"channel" : @((int) channel), @"errorCode" : @(errorCode)});
    }
}
...
- (void)onPlayerStateUpdate:(ZegoPlayerState)state errorCode:(int)errorCode extendedData:(NSDictionary *)extendedData streamID:(NSString *)streamID {
    ...
    if (sink) {
        ...
        sink(@{@"method" : @"onPlayerStateUpdate", @"state" : @(state), @"errorCode" : @(errorCode), @"extendedData" : extendedDataJsonString, @"streamID" : streamID});
    }
}
...
- (void)onPlayerMediaEvent:(ZegoPlayerMediaEvent)event streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerMediaEvent", @"event" : @(event), @"streamID" : streamID});
    }
}
...
- (void)onPlayerRecvAudioFirstFrame:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerRecvAudioFirstFrame", @"streamID" : streamID});
    }
}
...
- (void)onPlayerRecvVideoFirstFrame:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerRecvVideoFirstFrame", @"streamID" : streamID});
    }
}
...
- (void)onPlayerRenderVideoFirstFrame:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerRenderVideoFirstFrame", @"streamID" : streamID});
    }
}
...
- (void)onPlayerVideoSizeChanged:(CGSize)size streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerVideoSizeChanged", @"width" : @((int) size.width), @"height" : @((int) size.height), @"streamID" : streamID});
    }
}
...
#pragma clang diagnostic pop
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerRecvSEI", @"data" : [FlutterStandardTypedData typedDataWithBytes:data], @"streamID" : streamID});
    }
}
...
- (void)onPlayerRecvAudioSideInfo:(NSData *)data streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerRecvAudioSideInfo", @"data" : [FlutterStandardTypedData typedDataWithBytes:data], @"streamID" : streamID});
    }
}
...
- (void)onPlayerLowFpsWarning:(ZegoVideoCodecID)codecID streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onPlayerLowFpsWarning", @"codecID" : @(codecID), @"streamID" : streamID});
    }
}
...
- (void)onPlayerStreamEvent:(ZegoStreamEvent)eventID streamID:(NSString *)streamID extraInfo:(NSString *)extraInfo {
    ...
    if (sink) {
        sink(@{@"method" : @"onPlayerStreamEvent", @"eventID" : @(eventID), @"streamID" : streamID, @"extraInfo" : extraInfo});
    }
}
...
- (void)onPlayerRenderCameraVideoFirstFrame:(NSString *)streamID {
    ...
    if (sink) {
        sink(@{@"method" : @"onPlayerRenderCameraVideoFirstFrame", @"streamID" : streamID});
    }
}
...
- (void)onPlayerVideoSuperResolutionUpdate:(NSString *)streamID state:(ZegoSuperResolutionState)state errorCode:(int)errorCode {
    ...
    if (sink) {
        sink(@{@"method" : @"onPlayerVideoSuperResolutionUpdate", @"streamID" : streamID, @"state" : @(state), @"errorCode" : @(errorCode)});
    }
}
...
- (void)onMixerRelayCDNStateUpdate:(NSArray<ZegoStreamRelayCDNInfo *> *)infoList taskID:(NSString *)taskID {
    ...
    if (sink) {
        ...
        for (ZegoStreamRelayCDNInfo *info in infoList) {
            [infoListArray addObject:@{@"url" : info.url, @"state" : @(info.state), @"updateReason" : @(info.updateReason), @"stateTime" : @(info.stateTime)}];
        }

        sink(@{@"method" : @"onMixerRelayCDNStateUpdate", @"infoList" : infoListArray, @"taskID" : taskID});
    }
}
...
- (void)onMixerSoundLevelUpdate:(NSDictionary<NSNumber *, NSNumber *> *)soundLevels {
    ...
    if (sink) {
        sink(@{@"method" : @"onMixerSoundLevelUpdate", @"soundLevels" : soundLevels});
    }
}
...
- (void)onAutoMixerSoundLevelUpdate:(NSDictionary<NSString *, NSNumber *> *)soundLevels {
    ...
    if (sink) {
        sink(@{@"method" : @"onAutoMixerSoundLevelUpdate", @"soundLevels" : soundLevels});
    }
}
...
- (void)onCapturedSoundLevelUpdate:(NSNumber *)soundLevel {
    ...
    if (sink) {
        sink(@{@"method" : @"onCapturedSoundLevelUpdate", @"soundLevel" : soundLevel});
    }
}
...
- (void)onCapturedSoundLevelInfoUpdate:(ZegoSoundLevelInfo *)soundLevelInfo {
    ...
    if (sink) {
        sink(@{@"method" : @"onCapturedSoundLevelInfoUpdate", @"soundLevelInfo" : @{@"soundLevel" : @(soundLevelInfo.soundLevel), @"vad" : @(soundLevelInfo.vad)}});
    }
}
...
- (void)onRemoteSoundLevelUpdate:(NSDictionary<NSString *, NSNumber *> *)soundLevels {
    ...
    if (sink) {
        sink(@{@"method" : @"onRemoteSoundLevelUpdate", @"soundLevels" : soundLevels});
    }
}
...
- (void)onRemoteSoundLevelInfoUpdate:(NSDictionary<NSString *, ZegoSoundLevelInfo *> *)soundLevelInfos {
    ...
    [soundLevelInfos enumerateKeysAndObjectsUsingBlock:^(NSString *key, ZegoSoundLevelInfo *obj, BOOL *_Nonnull stop) {
      resultDic[key] = @{@"soundLevel" : @(obj.soundLevel), @"vad" : @(obj.vad)};
    }];

    if (sink) {
        sink(@{@"method" : @"onRemoteSoundLevelInfoUpdate", @"soundLevelInfos" : resultDic});
    }
}
...
- (void)onCapturedAudioSpectrumUpdate:(NSArray<NSNumber *> *)audioSpectrum {
    ...
    if (sink) {
        sink(@{@"method" : @"onCapturedAudioSpectrumUpdate", @"audioSpectrum" : audioSpectrum});
    }
}
...
- (void)onRemoteAudioSpectrumUpdate:(NSDictionary<NSString *, NSArray<NSNumber *> *> *)audioSpectrums {
    ...
    if (sink) {
        sink(@{@"method" : @"onRemoteAudioSpectrumUpdate", @"audioSpectrums" : audioSpectrums});
    }
}
...
- (void)onLocalDeviceExceptionOccurred:(ZegoDeviceExceptionType)exceptionType deviceType:(ZegoDeviceType)deviceType deviceID:(NSString *)deviceID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onLocalDeviceExceptionOccurred", @"exceptionType" : @(exceptionType), @"deviceType" : @(deviceType), @"deviceID" : deviceID});
    }
}
...
- (void)onRemoteCameraStateUpdate:(ZegoRemoteDeviceState)state streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRemoteCameraStateUpdate", @"state" : @(state), @"streamID" : streamID});
    }
}
...
- (void)onRemoteSpeakerStateUpdate:(ZegoRemoteDeviceState)state streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRemoteSpeakerStateUpdate", @"state" : @(state), @"streamID" : streamID});
    }
}
...
- (void)onRemoteMicStateUpdate:(ZegoRemoteDeviceState)state streamID:(NSString *)streamID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRemoteMicStateUpdate", @"state" : @(state), @"streamID" : streamID});
    }
}
...
- (void)onAudioDeviceStateChanged:(ZegoDeviceInfo *)deviceInfo updateType:(ZegoUpdateType)updateType deviceType:(ZegoAudioDeviceType)deviceType {
    ...
    if (sink) {
        sink(@{
            ...
            @"deviceInfo" : @{@"deviceID" : deviceInfo.deviceID, @"deviceName" : deviceInfo.deviceName},
            @"deviceType" : @(deviceType),
    ...
    if (sink) {
        ...
        for (ZegoBroadcastMessageInfo *info in messageList) {
            [messageListArray addObject:@{
                ...
                @"fromUser" : @{@"userID" : info.fromUser.userID, @"userName" : info.fromUser.userName}
            }];
        }

        sink(@{@"method" : @"onIMRecvBroadcastMessage", @"messageList" : messageListArray, @"roomID" : roomID});
    }
}
...
- (void)onIMRecvBarrageMessage:(NSArray<ZegoBarrageMessageInfo *> *)messageList roomID:(NSString *)roomID {
    ...
    if (sink) {
        ...
        sink(@{@"method" : @"onIMRecvBarrageMessage", @"messageList" : messageListArray, @"roomID" : roomID});
    }
}
...
- (void)onIMRecvCustomCommand:(NSString *)command fromUser:(ZegoUser *)fromUser roomID:(NSString *)roomID {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onIMRecvCustomCommand", @"command" : command, @"fromUser" : @{@"userID" : fromUser.userID, @"userName" : fromUser.userName}, @"roomID" : roomID});
    }
}
...
- (void)onNetworkModeChanged:(ZegoNetworkMode)mode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onNetworkModeChanged", @"mode" : @(mode)});
    }
}
...
- (void)onNetworkSpeedTestError:(int)errorCode type:(ZegoNetworkSpeedTestType)type {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onNetworkSpeedTestError", @"errorCode" : @(errorCode), @"type" : @(type)});
    }
}
...
- (void)onRecvExperimentalAPI:(NSString *)content {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRecvExperimentalAPI", @"content" : content});
    }
}
...
- (void)onNetworkQuality:(NSString *)userID upstreamQuality:(ZegoStreamQualityLevel)upstreamQuality downstreamQuality:(ZegoStreamQualityLevel)downstreamQuality {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onNetworkQuality", @"userID" : userID, @"upstreamQuality" : @(upstreamQuality), @"downstreamQuality" : @(downstreamQuality)});
    }
}
...
- (void)mediaPlayer:(ZegoMediaPlayer *)mediaPlayer stateUpdate:(ZegoMediaPlayerState)state errorCode:(int)errorCode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onMediaPlayerStateUpdate", @"mediaPlayerIndex" : mediaPlayer.index, @"state" : @(state), @"errorCode" : @(errorCode)});
    }
}
...
- (void)mediaPlayer:(ZegoMediaPlayer *)mediaPlayer networkEvent:(ZegoMediaPlayerNetworkEvent)networkEvent {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onMediaPlayerNetworkEvent", @"mediaPlayerIndex" : mediaPlayer.index, @"networkEvent" : @(networkEvent)});
    }
}
...
- (void)mediaPlayer:(ZegoMediaPlayer *)mediaPlayer playingProgress:(unsigned long long)millisecond {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onMediaPlayerPlayingProgress", @"mediaPlayerIndex" : mediaPlayer.index, @"millisecond" : @(millisecond)});
    }
}
...
- (void)rangeAudio:(ZegoRangeAudio *)rangeAudio microphoneStateUpdate:(ZegoRangeAudioMicrophoneState)state errorCode:(int)errorCode {
    ...
    GUARD_SINK
    if (sink) {
        sink(@{@"method" : @"onRangeAudioMicrophoneStateUpdate", @"rangeAudioIndex" : @(0), @"state" : @(state), @"errorCode" : @(errorCode)});
    }
}
...
- (void)onCapturedDataRecordStateUpdate:(ZegoDataRecordState)state errorCode:(int)errorCode config:(ZegoDataRecordConfig *)config channel:(ZegoPublishChannel)channel {
    FlutterEventSink sink = _eventSink;
    ZGLog(@"[onCapturedDataRecordStateUpdate] state: %d, errorCode: %d, filePath: %@, recordType: %d, channel: %d",
          (int) state,
          errorCode,
          config.filePath,
          (int) config.recordType,
          (int) channel);
    ...
    if (sink) {
        sink(@{
            ...
            @"state" : @((int) state),
            @"errorCode" : @(errorCode),
            @"config" : @{@"filePath" : config.filePath, @"recordType" : @((int) config.recordType)},
            @"channel" : @(channel)
        });
    }
}
...
- (void)onCapturedDataRecordProgressUpdate:(ZegoDataRecordProgress *)progress config:(ZegoDataRecordConfig *)config channel:(ZegoPublishChannel)channel {
    ...
    if (sink) {
        sink(@{
            ...
            @"progress" : @{@"duration" : @(progress.duration), @"currentFileSize" : @(progress.currentFileSize)},
            @"config" : @{@"filePath" : config.filePath, @"recordType" : @((int) config.recordType)},
            @"channel" : @(channel)
        });
    }
...
- (void)onCapturedAudioData:(const unsigned char *_Nonnull)data dataLength:(unsigned int)dataLength param:(ZegoAudioFrameParam *)param {
    ...
    if (sink) {
        sink(@{
            ...
            @"param" : @{@"sampleRate" : @(param.sampleRate), @"channel" : @(param.channel)}
        });
    }
}
...
- (void)onMixedAudioData:(const unsigned char *_Nonnull)data dataLength:(unsigned int)dataLength param:(ZegoAudioFrameParam *)param {
    ...
    if (sink) {
        sink(
            @{@"method" : @"onMixedAudioData", @"data" : objData, @"dataLength" : @(dataLength), @"param" : @{@"sampleRate" : @(param.sampleRate), @"channel" : @(param.channel)}});
    }
}
...
- (void)onProcessCapturedAudioDataAfterUsedHeadphoneMonitor:(unsigned char *)data
...
- (void)onAlignedAudioAuxData:(const unsigned char *_Nonnull)data dataLength:(unsigned int)dataLength param:(ZegoAudioFrameParam *)param {
    ...
    if (sink) {
        sink(@{@"method" : @"onAlignedAudioAuxData", @"data" : objData, @"param" : @{@"sampleRate" : @(param.sampleRate), @"channel" : @(param.channel)}});
    }
}

- (void)onProcessRemoteAudioData:(unsigned char *)data
                      dataLength:(unsigned int)dataLength
                           param:(ZegoAudioFrameParam *)param
...
- (void)onDownloadProgressUpdate:(ZegoCopyrightedMusic *)copyrightedMusic resourceID:(NSString *)resourceID progressRate:(float)progressRate {
    ...
    if (sink) {
        sink(@{@"method" : @"onDownloadProgressUpdate", @"resourceID" : resourceID, @"progressRate" : @(progressRate)});
    }
}
...
- (void)onCurrentPitchValueUpdate:(ZegoCopyrightedMusic *)copyrightedMusic resourceID:(NSString *)resourceID currentDuration:(int)currentDuration pitchValue:(int)pitchValue {
    ...
    if (sink) {
        sink(@{@"method" : @"onCurrentPitchValueUpdate", @"resourceID" : resourceID, @"currentDuration" : @(currentDuration), @"pitchValue" : @(pitchValue)});
    }
}
...
- (void)screenCapture:(ZegoScreenCaptureSource *)source exceptionOccurred:(ZegoScreenCaptureSourceExceptionType)type {
    ...
    if (sink) {
        sink(@{@"method" : @"onExceptionOccurred", @"screenCaptureSourceIndex" : [source getIndex], @"exceptionType" : @(type)});
    }
}
...
- (void)screenCapture:(ZegoScreenCaptureSource *)source windowState:(ZegoScreenCaptureWindowState)state windowRect:(CGRect)rect {
    ...
    if (sink) {
        sink(@{
            ...
            @"windowState" : @(state),
            @"windowRect" : @{@"x" : @(rect.origin.x), @"y" : @(rect.origin.y), @"width" : @(rect.size.width), @"height" : @(rect.size.height)}
        });
    }
}
...
- (void)screenCapture:(ZegoScreenCaptureSource *)source rectChanged:(CGRect)rect {
    ...
    if (sink) {
        sink(@{
            ...
            @"screenCaptureSourceIndex" : [source getIndex],
            @"captureRect" : @{@"x" : @(rect.origin.x), @"y" : @(rect.origin.y), @"width" : @(rect.size.width), @"height" : @(rect.size.height)}
        });
    }
}
#endif
...
- (void)aiVoiceChanger:(ZegoAIVoiceChanger *)aiVoiceChanger onInit:(int)errorCode {
    ...
    if (sink) {
        sink(@{@"method" : @"onAIVoiceChangerInit", @"aiVoiceChangerIndex" : @(aiVoiceChanger.getIndex), @"errorCode" : @(errorCode)});
    }
}
...
- (void)aiVoiceChanger:(ZegoAIVoiceChanger *)aiVoiceChanger onUpdate:(int)errorCode {
    ...
    if (sink) {
        sink(@{@"method" : @"onAIVoiceChangerUpdate", @"aiVoiceChangerIndex" : @(aiVoiceChanger.getIndex), @"errorCode" : @(errorCode)});
    }
}
...
- (void)aiVoiceChanger:(ZegoAIVoiceChanger *)aiVoiceChanger onGetSpeakerList:(int)errorCode speakers:(NSArray<ZegoAIVoiceChangerSpeakerInfo *> *)speakers {
    ...
    for (ZegoAIVoiceChangerSpeakerInfo *info in speakers) {
        NSDictionary *infoMap = @{@"name" : info.name, @"id" : @(info.id)};
        [speakerArray addObject:infoMap];
    }

    if (sink) {
        sink(@{@"method" : @"onAIVoiceChangerGetSpeakerList", @"aiVoiceChangerIndex" : @(aiVoiceChanger.getIndex), @"errorCode" : @(errorCode), @"speakerList" : speakerArray});
    }
}
