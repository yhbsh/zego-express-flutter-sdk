...
+ (void)createTexture:(ZGCVOpenGLTextureRef *)textureRef fromPixelBuffer:(CVPixelBufferRef)pixelBuffer cache:(ZGCVOpenGLTextureCacheRef)textureCache {
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    CVReturn res = CVOpenGLESTextureCacheCreateTextureFromImage(kCFAllocatorDefault,
                                                                ...
                                                                textureRef);
#elif TARGET_OS_OSX
    CVReturn res = CVOpenGLTextureCacheCreateTextureFromImage(kCFAllocatorDefault, textureCache, pixelBuffer, NULL, textureRef);
#endif
