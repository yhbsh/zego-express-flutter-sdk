...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    [ZegoExpressEngine createEngineWithAppID:appID
                                     appSign:appSign
                                   isTestEnv:isTestEnv
                                    scenario:(ZegoScenario) scenario
                                eventHandler:[ZegoExpressEngineEventHandler sharedInstance]];
#pragma clang diagnostic pop
    ...
    ZGLog(@"[createEngine] platform:iOS, enablePlatformView:%@, appID:%u, appSign:%@, isTestEnv:%@, scenario:%d",
          _enablePlatformView ? @"true" : @"false",
          appID,
          appSign,
...
- (void)setDummyCaptureImagePath:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if ([filePath hasPrefix:flutterAssetPrefix]) {
        ...
        if (!assetRealPath) {
            ZGLog(@"[setDummyCaptureImagePath] Can not get real path for flutter asset: '%@', please check if the asset is correctly declared in flutter project's pubspec.yaml",
                  assetName);
        } else {
...
- (void)loginRoom:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] loginRoom:roomID
                                           user:userObject
                                         config:configObject
                                       callback:^(int errorCode, NSDictionary *_Nullable extendedData) {
                                         ...
                                         result(@{@"errorCode" : @(errorCode), @"extendedData" : extendedDataJsonString});
                                       }];
}
...
- (void)logoutRoom:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if ([ZegoUtils isNullObject:roomID]) {
        ...
        [[ZegoExpressEngine sharedEngine] logoutRoomWithCallback:roomID
                                                        callback:^(int errorCode, NSDictionary *_Nullable extendedData) {
                                                          NSString *extendedDataJsonString = @"{}";
                                                          if (extendedData) {
                                                              NSError *error;
...
- (void)setRoomExtraInfo:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] setRoomExtraInfo:value
                                                forKey:key
                                                roomID:roomID
...
- (void)setStreamExtraInfo:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] setStreamExtraInfo:extraInfo
        ...
        if (self.enablePlatformView) {
            ...
            if (platformView) {
                ...
                NSString *errorMessage = [NSString
                    stringWithFormat:@"The PlatformView for viewID:%ld cannot be found, developer should call `createPlatformView` first and get the viewID", (long) viewID];
            ...
            if (![[ZegoTextureRendererController sharedInstance] bindCapturedChannel:@(channel) withTexture:viewID]) {
                ...
                NSString *errorMessage = [NSString
                    stringWithFormat:@"The TextureRenderer for textureID:%ld cannot be found, developer should call `createCanvasView` first and get the textureID", (long) viewID];
                ZGError(@"[startPreview] %@", errorMessage);
...
- (void)getAudioConfig:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    result(@{@"bitrate" : @(configObject.bitrate), @"channel" : @(configObject.channel), @"codecID" : @(configObject.codecID)});
}
...
- (void)takePublishStreamSnapshot:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine]
        takePublishStreamSnapshot:^(int errorCode, ZGImage *_Nullable image) {
          dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
              result(@{@"errorCode" : @(errorCode), @"image" : imageData ?: [[NSNull alloc] init]});
            });
          });
        }
                          channel:(ZegoPublishChannel) channel];
...
- (void)addPublishCdnUrl:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] addPublishCdnUrl:targetURL
                                              streamID:streamID
                                              callback:^(int errorCode) {
                                                result(@{@"errorCode" : @(errorCode)});
                                              }];
...
- (void)removePublishCdnUrl:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] removePublishCdnUrl:targetURL
                                                 streamID:streamID
                                                 callback:^(int errorCode) {
                                                   result(@{@"errorCode" : @(errorCode)});
                                                 }];
...
- (void)setPublishWatermark:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (watermarkMap && watermarkMap.count > 0) {
        ...
        if ([imageURL hasPrefix:flutterAssetPrefix]) {
            ...
            if (!assetRealPath) {
                ZGLog(@"[setPublishWatermark] Can not get real path for flutter asset: '%@', please check if the asset is correctly declared in flutter project's pubspec.yaml",
                      assetName);
            } else {
...
- (void)takePlayStreamSnapshot:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] takePlayStreamSnapshot:streamID
                                                    callback:^(int errorCode, ZGImage *_Nullable image) {
                                                      dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
                                                        NSData *imageData = nil;
                                                        if (image) {
#if TARGET_OS_IPHONE
...
- (void)startMixerTask:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (inputListMap && inputListMap.count > 0) {
        ...
        for (NSDictionary *inputMap in inputListMap) {
            ...
            ZegoMixerInput *inputObject  = [[ZegoMixerInput alloc] initWithStreamID:streamID
    ...
    [[ZegoExpressEngine sharedEngine] startMixerTask:taskObject
                                            callback:^(int errorCode, NSDictionary *_Nullable extendedData) {
                                              NSString *extendedDataJsonString = @"{}";
                                              if (extendedData) {
                                                  NSError *error;
...
- (void)stopMixerTask:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] stopMixerTask:taskObject
                                           callback:^(int errorCode) {
                                             result(@{@"errorCode" : @(errorCode)});
                                           }];
}
...
- (void)startAutoMixerTask:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] startAutoMixerTask:taskObject
                                                callback:^(int errorCode, NSDictionary *_Nullable extendedData) {
                                                  NSString *extendedDataJsonString = @"{}";
                                                  if (extendedData) {
                                                      NSError *error;
...
- (void)stopAutoMixerTask:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] stopAutoMixerTask:taskObject
                                               callback:^(int errorCode) {
                                                 result(@{@"errorCode" : @(errorCode)});
                                               }];
}
...
- (void)getAudioDeviceList:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    for (ZegoDeviceInfo *info in audioDeviceList) {
        [audioDeviceListResult addObject:@{@"deviceID" : info.deviceID, @"deviceName" : info.deviceName}];
    }
...
- (void)getVideoDeviceList:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    for (ZegoDeviceInfo *info in videoDeviceList) {
        [videoDeviceListResult addObject:@{@"deviceID" : info.deviceID, @"deviceName" : info.deviceName}];
    }
...
- (void)getCurrentAudioDevice:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    result(@{@"deviceID" : info.deviceID, @"deviceName" : info.deviceName});
}
...
- (void)sendCustomAudioCaptureAACData:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] sendCustomAudioCaptureAACData:(unsigned char *) [data.data bytes]
...
- (void)sendBroadcastMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] sendBroadcastMessage:message
                                                    roomID:roomID
                                                  callback:^(int errorCode, unsigned long long messageID) {
                                                    result(@{@"errorCode" : @(errorCode), @"messageID" : @(messageID)});
                                                  }];
}
...
- (void)sendBarrageMessage:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] sendBarrageMessage:message
                                                  roomID:roomID
                                                callback:^(int errorCode, NSString *_Nonnull messageID) {
                                                  result(@{@"errorCode" : @(errorCode), @"messageID" : messageID});
                                                }];
}
...
- (void)sendCustomCommand:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine] sendCustomCommand:command
                                             toUserList:userListObject
                                                 roomID:roomID
                                               callback:^(int errorCode) {
                                                 result(@{@"errorCode" : @(errorCode)});
                                               }];
...
- (void)mediaPlayerLoadResourceFromMediaData:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (mediaPlayer) {
        ...
        [mediaPlayer loadResourceFromMediaData:mediaData.data
...
- (void)mediaPlayerLoadResourceWithPosition:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (mediaPlayer) {
        ...
        [mediaPlayer loadResourceWithPosition:path
                                startPosition:startPosition
                                     callback:^(int errorCode) {
                                       result(@{@"errorCode" : @(errorCode)});
                                     }];
...
- (void)mediaPlayerGetNetWorkResourceCache:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (mediaPlayer) {
        ...
        result(@{@"time" : @(networkResourceCache.time), @"size" : @(networkResourceCache.size)});
    } else {
        result(@{});
    }
}
...
- (void)mediaPlayerLoadCopyrightedMusicResourceWithPosition:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (mediaPlayer) {
        ...
        [mediaPlayer loadCopyrightedMusicResourceWithPosition:resourceID
                                                startPosition:startPosition
                                                     callback:^(int errorCode) {
                                                       result(@{@"errorCode" : @(errorCode)});
                                                     }];
    ...
    if (mediaPlayer) {
        ...
        if (enable) {
            if (!self.enablePlatformView) {
                ...
                [mediaPlayer setVideoHandler:(id<ZegoMediaPlayerVideoHandler>) [ZegoMediaPlayerVideoManager sharedInstance]
                                      format:(ZegoVideoFrameFormat) format
                                        type:ZegoVideoBufferTypeCVPixelBuffer];
            }
        } else {
            if (!self.enablePlatformView) {
...
- (void)mediaPlayerLoadResourceWithConfig:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (mediaPlayer) {
        ...
        [mediaPlayer loadResourceWithConfig:resource
                                   callback:^(int errorCode) {
                                     result(@{@"errorCode" : @(errorCode)});
                                   }];
    } else {
        result([FlutterError errorWithCode:[@"loadResourceWithConfig_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `loadResourceWithConfig` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)destroyAudioEffectPlayer:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"destroyAudioEffectPlayer_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `destroyAudioEffectPlayer` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerStart:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerStart_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerStart` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerStop:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerStop_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerStop` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerPause:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerPause_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerPause` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerResume:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerResume_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerResume` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerStopAll:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerStopAll_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerStopAll` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerPauseAll:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerPauseAll_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerPauseAll` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerResumeAll:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerResumeAll_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerResumeAll` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerSeekTo:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        unsigned int       audioEffectID = [ZegoUtils unsignedIntValue:call.arguments[@"audioEffectID"]];
        unsigned long long millisecond   = [ZegoUtils unsignedLongLongValue:call.arguments[@"millisecond"]];
        [audioEffectPlayer seekTo:millisecond
                    audioEffectID:audioEffectID
                         callback:^(int errorCode) {
                           result(@{@"errorCode" : @(errorCode)});
                         }];
    } else {
        result([FlutterError errorWithCode:[@"audioEffectPlayerSeekTo_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerSeekTo` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerSetVolume:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerSetVolume_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerSetVolume` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerSetVolumeAll:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerSetVolumeAll_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerSetVolumeAll` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerGetTotalDuration:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerGetTotalDuration_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerGetTotalDuration` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerGetCurrentProgress:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerGetCurrentProgress_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerGetCurrentProgress` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerLoadResource:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        [audioEffectPlayer loadResource:path
                          audioEffectID:audioEffectID
                               callback:^(int errorCode) {
                                 result(@{@"errorCode" : @(errorCode)});
                               }];
    } else {
        result([FlutterError errorWithCode:[@"audioEffectPlayerLoadResource_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerLoadResource` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerUnloadResource:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerUnloadResource_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerUnloadResource` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerSetPlaySpeed:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerSetPlaySpeed_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerSetPlaySpeed` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)audioEffectPlayerUpdatePosition:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (audioEffectPlayer) {
        ...
        result([FlutterError errorWithCode:[@"audioEffectPlayerUpdatePosition_Can_not_find_player" uppercaseString]
                                   message:@"Invoke `audioEffectPlayerUpdatePosition` but can't find specific player"
                                   details:nil]);
    }
}
...
- (void)destroyMediaDataPublisher:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"destroyMediaDataPublisher_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `destroyMediaDataPublisher` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)mediaDataPublisherAddMediaFilePath:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"mediaDataPublisherAddMediaFilePath_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `mediaDataPublisherAddMediaFilePath` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)mediaDataPublisherGetCurrentDuration:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"mediaDataPublisherGetCurrentDuration_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `mediaDataPublisherGetCurrentDuration` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)mediaDataPublisherGetTotalDuration:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"mediaDataPublisherGetTotalDuration_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `mediaDataPublisherGetTotalDuration` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)mediaDataPublisherReset:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"mediaDataPublisherReset_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `mediaDataPublisherReset` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)mediaDataPublisherSeekTo:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"mediaDataPublisherSeekTo_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `mediaDataPublisherSeekTo` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)mediaDataPublisherSetVideoSendDelayTime:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (publisher) {
        ...
        result([FlutterError errorWithCode:[@"mediaDataPublisherSetVideoSendDelayTime_Can_not_find_publisher" uppercaseString]
                                   message:@"Invoke `mediaDataPublisherSetVideoSendDelayTime` but can't find specific publisher"
                                   details:nil]);
    }
}
...
- (void)destroyRangeAudio:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `destroyRangeAudio` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioEnableSpatializer:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioEnableSpatializer` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioEnableMicrophone:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioEnableMicrophone` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioEnableSpeaker:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioEnableSpeaker` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetAudioReceiveRange:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetAudioReceiveRange` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetMode:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetMode` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetTeamID:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetTeamID` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioUpdateSelfPosition:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioUpdateSelfPosition` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioMuteUser:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioMuteUser` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetPositionUpdateFrequency:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetPositionUpdateFrequency` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetRangeAudioVolume:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetRangeAudioVolume` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetStreamVocalRange:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetStreamVocalRange` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioUpdateStreamPosition:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioUpdateStreamPosition` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)rangeAudioSetRangeAudioCustomMode:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.rangeAudioInstance) {
        ...
        result([FlutterError errorWithCode:[@"rangeAudio_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `rangeAudioSetRangeAudioCustomMode` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)dataManagerSendRealTimeSequentialData:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (manager) {
        ...
        [manager sendRealTimeSequentialData:data.data
                                   streamID:streamID
                                   callback:^(int errorCode) {
                                     result(@{@"errorCode" : @(errorCode)});
                                   }];
        ...
        result([FlutterError errorWithCode:[@"dataManagerSendRealTimeSequentialData_Can_not_find_manager" uppercaseString]
                                   message:@"Invoke `dataManagerSendRealTimeSequentialData` but can't find data manager"
                                   details:nil]);
    }
}
...
- (void)dataManagerStartBroadcasting:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (manager) {
        ...
        result([FlutterError errorWithCode:[@"dataManagerStartBroadcasting_Can_not_find_manager" uppercaseString]
                                   message:@"Invoke `dataManagerStartBroadcasting` but can't find data manager"
                                   details:nil]);
    }
}
...
- (void)dataManagerStartSubscribing:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (manager) {
        ...
        result([FlutterError errorWithCode:[@"dataManagerStartSubscribing_Can_not_find_manager" uppercaseString]
                                   message:@"Invoke `dataManagerStartSubscribing` but can't find data manager"
                                   details:nil]);
    }
}
...
- (void)dataManagerStopBroadcasting:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (manager) {
        ...
        result([FlutterError errorWithCode:[@"dataManagerStopBroadcasting_Can_not_find_manager" uppercaseString]
                                   message:@"Invoke `dataManagerStopBroadcasting` but can't find data manager"
                                   details:nil]);
    }
}
...
- (void)dataManagerStopSubscribing:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (manager) {
        ...
        result([FlutterError errorWithCode:[@"dataManagerStopSubscribing_Can_not_find_manager" uppercaseString]
                                   message:@"Invoke `dataManagerStopSubscribing` but can't find data manager"
                                   details:nil]);
    }
}
...
- (void)startNetworkProbe:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    [[ZegoExpressEngine sharedEngine]
        startNetworkProbe:config
                 callback:^(int errorCode, ZegoNetworkProbeResult *_Nonnull probeResult) {
                   ...
                   if (probeResult.udpProbeResult) {
                       NSDictionary *udpProbeResultMap = @{@"errorCode" : @(probeResult.udpProbeResult.errorCode), @"rtt" : @(probeResult.udpProbeResult.rtt)};
...
- (void)getNetworkTimeInfo:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    result(@{@"timestamp" : @(info.timestamp), @"maxDeviation" : @(info.maxDeviation)});
}
...
- (void)destroyCopyrightedMusic:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `destroyCopyrightedMusic` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicClearCache:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicClearCache` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicDownload:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        NSString *resourceID = call.arguments[@"resourceID"];
        [self.copyrightedMusicInstance download:resourceID
                                       callback:^(int errorCode) {
                                         NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicDownload` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetAverageScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetAverageScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetCacheSize:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetCacheSize` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetCurrentPitch:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetCurrentPitch` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetDuration:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetDuration` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetKrcLyricByToken:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        [self.copyrightedMusicInstance getKrcLyricByToken:krcToken
                                                 callback:^(int errorCode, NSString *_Nonnull lyrics) {
                                                   NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                   resultMap[@"errorCode"]        = @(errorCode);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetKrcLyricByToken` but can't find specific instance"
                                   details:nil]);
    }
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
            [self.copyrightedMusicInstance getLrcLyric:songID
                                              callback:^(int errorCode, NSString *_Nonnull lyrics) {
#pragma clang diagnostic pop
                                                NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                resultMap[@"errorCode"]        = @(errorCode);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetLrcLyric` but can't find specific instance"
                                   details:nil]);
    }
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [self.copyrightedMusicInstance getMusicByToken:shareToken
                                              callback:^(int errorCode, NSString *_Nonnull resource) {
                                                NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                resultMap[@"errorCode"]        = @(errorCode);
...
#pragma clang diagnostic pop
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetMusicByToken` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetPreviousScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetPreviousScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetStandardPitch:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        NSString *resourceID = call.arguments[@"resourceID"];
        [self.copyrightedMusicInstance getStandardPitch:resourceID
                                               callback:^(int errorCode, NSString *_Nonnull pitch) {
                                                 NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                 resultMap[@"errorCode"]        = @(errorCode);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetStandardPitch` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetTotalScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetTotalScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicInitCopyrightedMusic:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        [self.copyrightedMusicInstance initCopyrightedMusic:config
                                                   callback:^(int errorCode) {
                                                     NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                     resultMap[@"errorCode"]        = @(errorCode);
                                                     result(resultMap);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicInitCopyrightedMusic` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicPauseScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicPauseScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
#pragma clang diagnostic pop
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicQueryCache` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicQueryCacheWithConfig:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicQueryCacheWithConfig` but can't find specific instance"
                                   details:nil]);
    }
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [self.copyrightedMusicInstance requestAccompaniment:config
                                                   callback:^(int errorCode, NSString *_Nonnull resource) {
                                                     NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                     resultMap[@"errorCode"]        = @(errorCode);
                                                     resultMap[@"resource"]         = resource;
...
#pragma clang diagnostic pop
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicRequestAccompaniment` but can't find specific instance"
                                   details:nil]);
    }
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [self.copyrightedMusicInstance requestAccompanimentClip:config
                                                       callback:^(int errorCode, NSString *_Nonnull resource) {
                                                         NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                         resultMap[@"errorCode"]        = @(errorCode);
                                                         resultMap[@"resource"]         = resource;
...
#pragma clang diagnostic pop
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicRequestAccompanimentClip` but can't find specific instance"
                                   details:nil]);
    }
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [self.copyrightedMusicInstance requestSong:config
                                          callback:^(int errorCode, NSString *_Nonnull resource) {
                                            NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                            resultMap[@"errorCode"]        = @(errorCode);
                                            resultMap[@"resource"]         = resource;
...
#pragma clang diagnostic pop
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicRequestSong` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicResetScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicResetScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicResumeScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicResumeScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicSendExtendedRequest:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        [self.copyrightedMusicInstance sendExtendedRequest:command
                                                    params:params
                                                  callback:^(int errorCode, NSString *_Nonnull command, NSString *_Nonnull result_) {
                                                    NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                    resultMap[@"errorCode"]        = @(errorCode);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicSendExtendedRequest` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicStartScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicStartScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicStopScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicStopScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetFullScore:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetFullScore` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicGetSharedResource:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        [self.copyrightedMusicInstance getSharedResource:config
                                                    type:type
                                                callback:^(int errorCode, NSString *_Nonnull resource) {
                                                  NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                  resultMap[@"errorCode"]        = @(errorCode);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicGetSharedResource` but can't find specific instance"
                                   details:nil]);
    }
}
...
- (void)copyrightedMusicRequestResource:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if (self.copyrightedMusicInstance) {
        ...
        ZegoCopyrightedMusicResourceType type = (ZegoCopyrightedMusicResourceType) [ZegoUtils intValue:call.arguments[@"type"]];
        [self.copyrightedMusicInstance requestResource:config
                                                  type:type
                                              callback:^(int errorCode, NSString *_Nonnull resource) {
                                                NSMutableDictionary *resultMap = [[NSMutableDictionary alloc] init];
                                                resultMap[@"errorCode"]        = @(errorCode);
        ...
        result([FlutterError errorWithCode:[@"copyrightedMusic_Can_not_find_Instance" uppercaseString]
                                   message:@"Invoke `copyrightedMusicRequestResource` but can't find specific instance"
                                   details:nil]);
    }
}
